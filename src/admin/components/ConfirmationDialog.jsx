          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                onClick={onConfirm}
                className={`inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto ${confirmButtonText.toLowerCase() === 'delete' ? 'bg-red-600 hover:bg-red-500' : 'bg-primary-600 hover:bg-primary-700'}`}
              >
                {confirmButtonText}
              </button>
              <button
